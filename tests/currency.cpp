...
TEST(FromString, PositiveValues) {
	EXPECT_EQ(currency<currency_locale::USD>::from_string("$1,234.50").minor_units, 123450);
	EXPECT_EQ(currency<currency_locale::USD>::from_string("$1.50").minor_units, 150);
	EXPECT_EQ(currency<currency_locale::USD>::from_string("1.5").minor_units, 150);
}
...
TEST(FromString, MalformedStrings) {
	EXPECT_EQ(currency<currency_locale::USD>::from_string("$x1a,b2c3d4e.f5-g0h.i012").minor_units, 123450);
	EXPECT_EQ(currency<currency_locale::USD>::from_string("abc").minor_units, 0);
	EXPECT_EQ(currency<currency_locale::USD>::from_string("").minor_units, 0);
}
