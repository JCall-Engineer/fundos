...
struct statements {
	statement_slot get_users { .sql = R"sql(SELECT * FROM users)sql" };
	statement_slot insert_user { .sql = R"sql()sql" };
	statement_slot delete_user { .sql = R"sql()sql" };

	statement_slot get_user_accounts { .sql = R"sql()sql" };
	statement_slot get_account_users { .sql = R"sql()sql" };
	statement_slot add_user_to_account { .sql = R"sql()sql" };
	statement_slot remove_user_from_account { .sql = R"sql()sql" };

	statement_slot get_user_funds { .sql = R"sql()sql" };
	statement_slot get_fund_users { .sql = R"sql()sql" };
	statement_slot add_user_to_fund { .sql = R"sql()sql" };
	statement_slot remove_user_from_fund { .sql = R"sql()sql" };

	statement_slot get_funds { .sql = R"sql()sql" };
	statement_slot get_fund_balance { .sql = R"sql()sql" };
	statement_slot insert_fund { .sql = R"sql()sql" };
	statement_slot update_fund { .sql = R"sql()sql" };

	statement_slot get_accounts { .sql = R"sql()sql" };
	statement_slot get_account_balance { .sql = R"sql()sql" };
	statement_slot insert_account { .sql = R"sql()sql" };
	statement_slot update_account { .sql = R"sql()sql" };

	statement_slot get_budgets { .sql = R"sql()sql" };
	statement_slot insert_budget { .sql = R"sql()sql" };
	statement_slot update_budget { .sql = R"sql()sql" };
	statement_slot delete_budget { .sql = R"sql()sql" };

	statement_slot get_phases { .sql = R"sql()sql" };
	statement_slot insert_phase { .sql = R"sql()sql" };
	statement_slot update_phase { .sql = R"sql()sql" };
	statement_slot delete_phase { .sql = R"sql()sql" };

	statement_slot get_targets { .sql = R"sql()sql" };
	statement_slot insert_target { .sql = R"sql()sql" };
	statement_slot update_target { .sql = R"sql()sql" };
	statement_slot delete_target { .sql = R"sql()sql" };

	statement_slot filter_transactions { .sql = R"sql()sql" };
	statement_slot insert_transaction { .sql = R"sql()sql" };
	statement_slot update_transaction { .sql = R"sql()sql" };

	statement_slot filter_allocations { .sql = R"sql()sql" };
	statement_slot insert_allocation { .sql = R"sql()sql" };
